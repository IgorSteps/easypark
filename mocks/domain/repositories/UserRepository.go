...
func (_m *UserRepository) GetDriverByUsername(ctx context.Context, username string) (*entities.User, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetDriverByUsername")
	}
...
// UserRepository_GetDriverByUsername_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetDriverByUsername'
type UserRepository_GetDriverByUsername_Call struct {
	*mock.Call
}

// GetDriverByUsername is a helper method to define mock.On call
//   - ctx context.Context
//   - username string
func (_e *UserRepository_Expecter) GetDriverByUsername(ctx interface{}, username interface{}) *UserRepository_GetDriverByUsername_Call {
	return &UserRepository_GetDriverByUsername_Call{Call: _e.mock.On("GetDriverByUsername", ctx, username)}
}

func (_c *UserRepository_GetDriverByUsername_Call) Run(run func(ctx context.Context, username string)) *UserRepository_GetDriverByUsername_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *UserRepository_GetDriverByUsername_Call) Return(_a0 *entities.User, _a1 error) *UserRepository_GetDriverByUsername_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_m *UserRepository) Save(ctx context.Context, user *entities.User) error {
	ret := _m.Called(ctx, user)
...
func (_c *UserRepository_Save_Call) RunAndReturn(run func(context.Context, *entities.User) error) *UserRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
