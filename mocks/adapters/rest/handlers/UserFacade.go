...
func (_m *UserFacade) AuthoriseUser(ctx context.Context, username string, password string) (*entities.User, string, error) {
...
func (_c *UserFacade_AuthoriseUser_Call) Return(_a0 *entities.User, _a1 string, _a2 error) *UserFacade_AuthoriseUser_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *UserFacade_AuthoriseUser_Call) RunAndReturn(run func(context.Context, string, string) (*entities.User, string, error)) *UserFacade_AuthoriseUser_Call {
	_c.Call.Return(run)
	return _c
}
