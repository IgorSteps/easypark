...
func (_m *ParkingLotFacade) DeleteParkingLot(ctx context.Context, id uuid.UUID) error {
...
// ParkingLotFacade_DeleteParkingLot_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteParkingLot'
type ParkingLotFacade_DeleteParkingLot_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - id uuid.UUID
func (_e *ParkingLotFacade_Expecter) DeleteParkingLot(ctx interface{}, id interface{}) *ParkingLotFacade_DeleteParkingLot_Call {
	return &ParkingLotFacade_DeleteParkingLot_Call{Call: _e.mock.On("DeleteParkingLot", ctx, id)}
}

func (_c *ParkingLotFacade_DeleteParkingLot_Call) Run(run func(ctx context.Context, id uuid.UUID)) *ParkingLotFacade_DeleteParkingLot_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ParkingLotFacade_DeleteParkingLot_Call) Return(_a0 error) *ParkingLotFacade_DeleteParkingLot_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ParkingLotFacade_DeleteParkingLot_Call) RunAndReturn(run func(context.Context, uuid.UUID) error) *ParkingLotFacade_DeleteParkingLot_Call {
	_c.Call.Return(run)
	return _c
}
