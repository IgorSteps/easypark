...
// Execute provides a mock function with given fields: ctx, driverID, spaceID, location, notificationType
func (_m *NotificationCreator) Execute(ctx context.Context, driverID uuid.UUID, spaceID uuid.UUID, location string, notificationType int) (entities.Notification, error) {
...
func (_e *NotificationCreator_Expecter) Execute(ctx interface{}, driverID interface{}, spaceID interface{}, location interface{}, notificationType interface{}) *NotificationCreator_Execute_Call {
	return &NotificationCreator_Execute_Call{Call: _e.mock.On("Execute", ctx, driverID, spaceID, location, notificationType)}
}

func (_c *NotificationCreator_Execute_Call) Run(run func(ctx context.Context, driverID uuid.UUID, spaceID uuid.UUID, location string, notificationType int)) *NotificationCreator_Execute_Call {
...
func (_c *NotificationCreator_Execute_Call) RunAndReturn(run func(context.Context, uuid.UUID, uuid.UUID, string, int) (entities.Notification, error)) *NotificationCreator_Execute_Call {
	_c.Call.Return(run)
	return _c
}
