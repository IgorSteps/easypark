...
func SetupApp() (*App, error) {
	...
	parkingRequestFacade := usecasefacades.NewParkingRequestFacade(createParkingRequest, updateParkingRequestStatus, updateParkingRequestSpace, getAllParkingRequests)
