...
func SetupApp() (*App, error) {
	...
	automaticAssignParkingSpace := usecases2.NewAutomaticAssignParkingSpace(logrusLogger, parkingRequestPostgresRepository, parkingSpacePostgresRepository)
	deassignParkingSpace := usecases2.NewDeassignParkingSpace(logrusLogger, parkingRequestPostgresRepository)
	parkingRequestFacade := usecasefacades.NewParkingRequestFacade(createParkingRequest, updateParkingRequestStatus, assignParkingSpace, getAllParkingRequests, getDriversParkingRequests, automaticAssignParkingSpace, deassignParkingSpace)
	...
	checkOverStays := usecases5.NewCheckOverStays(logrusLogger, parkingRequestPostgresRepository, createAlert)
	getAllAlerts := usecases5.NewGetAllAlerts(logrusLogger, alertPostgresRepository)
	alertFacade := usecasefacades.NewAlertFacade(getSingleAlert, checkLateArrival, checkOverStays, getAllAlerts)
